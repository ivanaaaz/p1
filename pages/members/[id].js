...
export default function MemberDetails() {
  ...
  return (
    <div>
      <h1 className="mt-10 md:mt-16 mb-6 lg:mt-20 text-secondary-300 lg:text-6xl md:text-5xl text-4xl text-center px-16 py-16">
        Details of members
      </h1>
      ...
      <p className="flex justify-center h-52 md:h-64 lg:h-80 width-full object-cover mb-40 mt-10">
